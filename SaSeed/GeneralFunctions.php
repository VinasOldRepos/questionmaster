...
*************************************************************************************/
	...
	Final class General {
		 ...
		 * @return string */
		public static function data_mysql ($data='now') {
			// Se data não enviada
			if ($data == 'now') {
		 ...
		 * @return string */
		public static function data_bras_mysql ($data='now') {
			// Se data não enviada
			if ($data == 'now') {
				// Monta data com dia de hoje
				$dt_dia	= date("d");
		 ...
		 * @param string	- Data no formato ("2011-10-17 09:40:42" ou "2011/10/17 09:40:42")
		 * @return string */
		public static function data_php ($data='now') {
			// Se data não enviada
			if ($data == 'now') {
				// Monta data com dia de hoje
				$dt_dia	= date("d");
		 ...
		 * @param string	- Data no formato ("2011-10-17 09:40:42" ou "2011/10/17 09:40:42")
		 * @return string */
		public static function datahora_php ($data='now') {
			// Se data não enviada
			if ($data == 'now') {
				// Monta data com dia de hoje
				$dt_dia		= date("d");
		 ...
		 * @param string	- Data no formato ("2011-10-17 09:40:42" ou "2011/10/17 09:40:42")
		 * @return string */
		public static function datahora_mysql ($data='now') {
			// Se data não enviada
			if ($data == 'now') {
				// Monta data com dia de hoje
				$dt_dia		= date("d");
		...
		/* Função que tira aspas simples e dupla e substitui por cod html
		 * @param string	- input text
		 * @return string */
		public static function quotes($string=false) {
			if ($string) {
				// REFERENCES -> http://www.ascii.cl/htmlcodes.htm
